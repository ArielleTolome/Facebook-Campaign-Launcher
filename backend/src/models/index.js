...
const AudienceTemplate = require('./AudienceTemplate');
...
AudienceTemplate.hasMany(Audience, { foreignKey: 'template_id', as: 'audiences' });
Audience.belongsTo(AudienceTemplate, { foreignKey: 'template_id', as: 'template' });
